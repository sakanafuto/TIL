# 【Flutter】Linter Formatterについて

# はじめに

Flutter開発をしていて、ここ指摘されるのにここはいいのかとか、ただインデントを揃えるだけのむだなコミットをしてしまったりとか、Dartコードの書き方について気になることが増えてきたのでFlutterにおけるFormatterや静的解析について調べてみました。

Formatterや静的解析を学ぶことでもちろん良いコードについて学ぶいい機会にもなりましたが、そのおまけとしてそれらツールを自動化したり、インポート文を整形してくれるライブラリも見つけたりしましたのでご紹介いたします。

この記事で紹介したことを導入すると、以下の項目ができるようになります。

- コードの整形ミスがなくなる（Formatter）
- 文法や必要のない箇所について事前に修正することができる（Linter）
- これらを$ git commit直前に実行する
